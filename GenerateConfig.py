...
class GenerateConfig:
    ...
    SectionNames=("Personal Details","Current Address","Previous Address","Contact Details","Professional Contacts","Bank Account Details","Family And Dependants","ID Verification","Current Employment Details","Assets","Liabilities","Expenditure","Existing Mortgage","Mortgage Requirements")
    ...
    def fnc_CreateDefaultFile(self):    
        ...
        self.config_file.set("InputTemplate", "IO_Template_MortgageRequirements","[Builder Gift][Customers Bank][Equity][Gifted Deposit][Immediate Family Gift][Inheritance][Loan][Proceeds of house sale][Sale Of Other Property][Vendor Gifted],Owner,[Purchase][Re-mortgage][Product Transfer][Additional Borrow],Mortgage Type,Property,Number of Bedrooms,Number of living rooms,Number of kitchen,Number of Toilets,Number of bathrooms,[on-site parking][off-street parking],[Yes][No],[Yes][No],"+
